...
import vertexShaders from "../common/shaders/ch06/06_vertexShader.vert";
import fragmentShaders from "../common/shaders/ch06/06_fragmentShader.frag";
  ...
  try {
    scene.traverse(object => {
      ...
      if (light) {
        ...
        // TODO. object.diffuse type (number[] → vec4)
